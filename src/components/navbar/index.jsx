...
export default function Navbar() {
    ...
    return <nav className="flex justify-between items-center py-8 container mx-auto flex-col lg:flex-row gap-5 lg:gap:0 slide-in-left">
        ...
        <form onSubmit={handleSubmit}>
            <input type="text" name="search" placeholder="Enter Items..." className="bg-white/75 p-3 rounded-full outline-none lg:w-96 shadow-lg shadow-orange-100 focus:shadow-orange-200" value={searchParam} onChange={(event) => setSearchParam(event.target.value)} />
        </form>
